      ...
      <div className={styles.bookModal} onClick={(e)=>{console.log(e.target)}}>
        ...
        <div className={styles.ModalBody}>
          <div className={styles.leftSeat}>
            잔여좌석<span className={styles.canBookCnt}>{bookingData.allSeat-bookingData.bookedSeatCnt}</span><span className={styles.allSeatCnt}>/{bookingData.allSeat*2}</span>
          </div>
          ...
          <div className={styles.ageInfo}>
            ...
            {bookingData.ageCut===0?
              ...
              <p className={styles.warning}>
                만{bookingData.ageCut}세 미만의 고객님(영, 유아 포함)은 반드시 부모님 또는 성인 보호자의 동반하에 관람이 가능합니다. 연령확인 불가 시 입장이 제한될 수 있습니다.
              </p>
            }
          </div>
